...
int GetLastPowBlock()
{
     ...
     if (pindexBest->nHeight < 405000)
     {
        LAST_POW_BLOCK=500;
     } else if (pindexBest->nHeight >= 405000 && pindexBest->nHeight <= 405100)
     {
        LAST_POW_BLOCK=405100;
     }
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    {
        nSubsidy = 10 * COIN;
    } else if (pindexBest->nHeight >= 405000 && pindexBest->nHeight <= 405050)
    {
